...
DEFAULT_ROTATE = 1  # 0-0, 1-90, 2-180, 3-270
...
class LCD_28_ILI9341(object):
    ...
    def LCD_Init(self):     
        self.LCD_Write_Reg(0xCF, b"\x00\xC9\x30") 
        self.LCD_Write_Reg(0xED, b"\x64\x03\x12\x81")
        self.LCD_Write_Reg(0xE8, b"\x85\x10\x7A")
        self.LCD_Write_Reg(0xCB, b"\x39\x2C\x00\x34\x02")
        self.LCD_Write_Reg(0xF7, b"\x20")
        self.LCD_Write_Reg(0xEA, b"\x00\x00")
        self.LCD_Write_Reg(0xC0, b"\x1B")
        self.LCD_Write_Reg(0xC1, b"\x00")  
        self.LCD_Write_Reg(0xC5, b"\x44\x30")
        self.LCD_Write_Reg(0xC7, b"\xB6")        
        self.LCD_Write_Reg(0x36, b"\x08")
        self.LCD_Write_Reg(0x3A, b"\x55")
        self.LCD_Write_Reg(0xB1, b"\x00\x1A")
        self.LCD_Write_Reg(0xB6, b"\x0A\xA2")
        self.LCD_Write_Reg(0xF2, b"\x00")
        self.LCD_Write_Reg(0x26, b"\x01")
        self.LCD_Write_Reg(0xE0, b"\x0F\x2A\x28\x08\x0E\x08\x54\xA9\x43\x0A\x0F\x00\x00\x00\x00")        
        self.LCD_Write_Reg(0XE1, b"\x00\x15\x17\x07\x11\x06\x2B\x56\x3C\x05\x10\x0F\x3F\x3F\x0F")        
        self.LCD_Write_Reg(0x2B, b"\x00\x00\x01\x3F")
        self.LCD_Write_Reg(0x2A, b"\x00\x00\x00\xEF")
